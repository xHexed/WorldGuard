...
public class RecordMessagePrefixer extends Handler {
    ...
    public RecordMessagePrefixer(final Logger parentLogger, final String prefix) {
     ...
     */
    public static void register(final Logger logger, final String prefix) {
        checkNotNull(logger);

        // Fix issues with multiple classloaders loading the same class
        final String className = RecordMessagePrefixer.class.getCanonicalName();
