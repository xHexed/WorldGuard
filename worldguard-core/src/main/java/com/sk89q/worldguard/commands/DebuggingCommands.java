...
public class DebuggingCommands {
     ...
     */
    public DebuggingCommands(final WorldGuard worldGuard) {
    ...
    public void fireBreakEvent(final CommandContext args, final Actor sender) throws CommandException {
    ...
    @CommandPermissions("worldguard.debug.event")
    public void firePlaceEvent(final CommandContext args, final Actor sender) throws CommandException {
        final LocalPlayer target = worldGuard.getPlatform().getMatcher().matchSinglePlayer(sender, args.getString(0));
    ...
    @CommandPermissions("worldguard.debug.event")
    public void fireInteractEvent(final CommandContext args, final Actor sender) throws CommandException {
        final LocalPlayer target = worldGuard.getPlatform().getMatcher().matchSinglePlayer(sender, args.getString(0));
    ...
    @CommandPermissions("worldguard.debug.event")
    public void fireDamageEvent(final CommandContext args, final Actor sender) throws CommandException {
        final LocalPlayer target = worldGuard.getPlatform().getMatcher().matchSinglePlayer(sender, args.getString(0));
